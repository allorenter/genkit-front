...
import { theme, iconButton } from '../styles/styles';
        ...
        <Draggable draggableId={props.name} index={props.index}>
            {
                (provided) => (
                    ...
                    >
                        <Row style={{
                            padding: '.5em',
                            borderBottom: optionsComponent[props.type.id] ? '1px solid #ededed' : 'none'
                        }}>
                            ...
                            >
                                ...
                                {selectedProperties.length > 1 && <IconButton
                                    type='link'
                                    onClick={
                                        () => setSelectedProperties(
                                            selectedProperties.filter((property) => property.name !== props.name)
                                        )
                                    }
                                >
                                    <DeleteOutlined />
                        ...
                        {optionsComponent[props.type.id] && <Row style={{ padding: '.5em .5em .5em 1.5em' }}>
